...
interface AppStore {
  ...
  setWorkspace(urls: string[], tailorJobs: Record<string, TailorJob>, applySessions: Record<string, ApplySession>): void;
...
export const useStore = create<AppStore>()(
  persist(
    (set) => ({
      ...
      setJobUrls: (urls) => set({ jobUrls: urls }),
      setWorkspace: (urls, tailorJobs, applySessions) => set({ jobUrls: urls, tailorJobs, applySessions }),
